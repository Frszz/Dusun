        ...
        <div class="container">
            ...
            <h1>Berita</h1>
                ...
                <div class="content">
                    <?php
                        $id = @$_GET['id'];
                        $sql_berita = mysqli_query($con, "SELECT * FROM berita WHERE ID = '$id'") or die (mysqli_error($con));
                    ...
                    ?>
                            <form action="prosesBerita.php" method="POST" enctype="multipart/form-data">
                                <div>
                                    ...
                                    <input type="text" id="Judul" name="Judul" value="<?=$data['Judul']?>" placeholder="Masukkan Judul..." required autofocus>
                                </div>
                                <div class="form-group">
                                    <label for="Kategori">Kategori</label>
                                    <?php
                                        echo "<select id=\"Kategori\" name=\"Kategori\">
                                            <option value=\"\" disabled selected style=\"display:none;\">".$data['Kategori']."</option>";
                                ...
                                <div>
                                    ...
                                    <textarea id="Deskripsi" name="Deskripsi" rows="3" cols="6" required><?=$data['Deskripsi']?></textarea>
                                    <script>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="Author" name="Author" value="<?=$data['Author']?>" placeholder="Nama Pengarang..." required>
                                </div>
                                <div>
