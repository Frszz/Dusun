...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CSS/styleInsertWarga2.css">
    ...
    <body>
                ...
                <div class="content">
                    <form action="prosesWarga.php" method="POST">
                        <div>
                            ...
                            <input type="text" id="Nama" name="Nama" placeholder="Masukkan Nama..." required autofocus>
                        </div>
                        <div>
                            <label for="Hp">No. Hp</label>
                            <input type="text" id="Hp" name="Hp" placeholder="Masukkan Nomor Telepon..." required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id="Alamat" name="Alamat" placeholder="Masukkan Alamat..." required></input>
                        </div>
                        <div class="tmbl1">
        ...
        <script src="js/scriptInsertWarga.js"></script>
    </body>
</html>
<?php
    } else{
